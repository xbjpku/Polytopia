...
public class MySliderUI extends BasicSliderUI {
    ...
    public void paintThumb(Graphics g) {
        ...
        g2d.setColor(new Color(0, 0, 255, 160));
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
                RenderingHints.VALUE_ANTIALIAS_ON);
        // 填充椭圆框为当前thumb位置
        g2d.fillRoundRect(thumbRect.x, thumbRect.y, thumbRect.width,
                thumbRect.height, 12, 12);
    ...
    public void paintTrack(Graphics g) {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            // 设定渐变
            g2.setPaint(new GradientPaint(0, 0, new Color(0, 64, 128), cw, 0,
                    new Color(0, 192, 255), true));
