...
public class LaunchWindow extends JFrame {
    ...
    JLabel NewGame, LoadGame, Options, ExitGame;
    ...
    public LaunchWindow() {
        ...
        int dx = 7 * width / 16, dy = (int)(6.6 * height / 18);
        int dw = width / 8, dh = (int)(dw / 4.1);
        ...
        MouseAdapter adapter = new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                if (e.getSource().equals(NewGame)) {
                    ...
                    Options.setBackground(new Color(47, 148, 238));
        ...
        Options = new ButtonLabel("OPTIONS", dx, dy + 2 * (dh + dh / 8), dw, dh);
        Options.addMouseListener(adapter);
        this.add(Options);

        ExitGame = new ButtonLabel("EXIT GAME", dx, dy + 3 * (dh + dh / 8), dw, dh);
        ExitGame.addMouseListener(adapter);
        this.add(ExitGame);

        MainPanel panel = new MainPanel("./resources/window/mainwithbutton.png");
        this.add(panel);
